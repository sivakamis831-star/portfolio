...
const About = () => {
  return (
    <section id="about" className="scroll-mt-28 relative group select-none py-12">
      <div className="absolute -top-16 -left-12 w-80 h-80 bg-purple-500/5 rounded-full blur-[120px] pointer-events-none" />
      
      <div className="relative overflow-hidden bg-gradient-to-br from-[#121729]/90 via-[#0a0d17]/40 to-[#121729]/90 border border-gray-800/50 rounded-3xl p-8 md:p-14 backdrop-blur-xl shadow-[0_25px_60px_rgba(0,0,0,0.5)] hover:border-purple-500/20 transition-all duration-500">
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-14 items-start">
          ...
          <div className="md:col-span-7 space-y-6 text-gray-400 font-light leading-relaxed text-base md:text-lg">
            ...
            <div className="grid grid-cols-2 gap-4 pt-8 border-t border-gray-800/40 mt-10">
              <div className="p-5 rounded-2xl bg-[#090d16]/40 border border-gray-800/60 transition-all duration-300 hover:border-purple-500/20 hover:-translate-y-1 group/stat">
                <p className="text-3xl md:text-4xl font-black text-white font-mono bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent group-hover/stat:from-purple-300 group-hover/stat:to-purple-500">03+</p>
                <p className="text-[10px] text-gray-500 uppercase tracking-[0.15em] font-medium mt-1.5">Years Experience</p>
              </div>
              <div className="p-5 rounded-2xl bg-[#090d16]/40 border border-gray-800/60 transition-all duration-300 hover:border-purple-500/20 hover:-translate-y-1 group/stat">
                <p className="text-3xl md:text-4xl font-black text-white font-mono bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent group-hover/stat:from-indigo-300 group-hover/stat:to-indigo-500">40+</p>
                <p className="text-[10px] text-gray-500 uppercase tracking-[0.15em] font-medium mt-1.5">Systems Delivered</p>
              </div>
            </div>
          </div>
